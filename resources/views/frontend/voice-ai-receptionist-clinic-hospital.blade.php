...
@section('title', 'AI Receptionist for Hospitals and Clinics in India - Tatkal Doctor')
@section('description', 'Automate your Hospitals and Clinics with the top AI Receptionist in India. Smart AI voice agents for 24/7 patient appointments and call management. Boost efficiency today!')
@section('canonical', 'https://www.tatkaldoctor.com/voice-ai-receptionist-clinic-hospital')
@section('robots', 'index, follow')
@section('og:title', 'AI Receptionist for Hospitals and Clinics in India - Tatkal Doctor')
@section('og:url', 'https://www.tatkaldoctor.com/voice-ai-receptionist-clinic-hospital')
@section('og:description', 'Automate your Hospitals and Clinics with the top AI Receptionist in India. Smart AI voice agents for 24/7 patient appointments and call management. Boost efficiency today!')
@section('og:image', '')
...
@section('content')
  ...
  <section class="hero" aria-label="Hero">
    ...
    <div class="hero__inner">
      ...
      <div id="msg" class="hero__message"></div>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!el) {
        console.log("typed-text not found");
        return;
    }
